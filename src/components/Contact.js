        ...
        <section id="contact" className="relative">
            <div className=" container px-5 py-10 mx-auto flex sm:flex-nowrap flex-wrap">
                <div className="lg:w-2/3 md:w-1/2 bg-gray-900 rounded-lg overflow-hidden sm:mr-10 p-10 items-end justify-start relative">
                    ...
                    src="https://www.google.com/maps/embed/v1/place?q=Gandu,+BA,+Brasil&key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8"
                    />
                    <div className="bg-gray-900 relative flex flex-wrap py-6 rounded shadow-md">
                        ...
                        <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
                            ...
                            <a className="text-indigo-400 leading-relaxed">
                                Itamaranvet@gmail.com
                            </a>
                            <h2 className="title-font semibold-font text-white tracking-widest text-xs mt-4">
                                PHONE
                            </h2>
            ...
            <div className="relative mb-4">
                ...
                id="message"
                name="newssage"
                className="w-full bg-gray-800 rounded border border-gray-700 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-900 h-32 text-base outline-none text-gray-100 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out"
